...
<div id="divEditPersiapan" class="divMain">
	<form id="formEditPersiapan" method="post" action="prosesEditPersiapan.php">
		<div class="baris">
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		function simpanData(){
			var formData = $("#formEditPersiapan").serialize();

			$.ajax({
				url: 'prosesEditPersiapan.php',
				type: 'POST',
				data: formData
			})
			.done(function() {
				console.log("success");
				swal({
						title: "Edit Data Berhasil Tersimpan!",
						type: "success",
		...
		$(document).on("click", "#btnReload", function(){
			...
			$(".content").load("editMenyambutPersalinan.php", {noReg: nmr}, function(){
