...
<div id="divEditCatKesehatanIbuHamil" class="divMain">
	<form id="formEditCatKesehatanIbuHamil" method="post" action="prosesEditCatIbuHamil.php">
		<div class="baris">
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		function simpanData(){
			var formData = $("#formEditCatKesehatanIbuHamil").serialize();

			$.ajax({
				url: 'prosesEditCatIbuHamil.php',
				type: 'POST',
				data: formData
			})
			.done(function() {
				console.log("success");
				swal({
						title: "Edit Catatan Kesehatan Berhasil!",
						type: "success",
		...
		$(document).on("submit", "#formEditCatKesehatanIbuHamil", function(event){
		...
		$(document).on("click", "#btnSimpan", function(){
			...
			swal({
				  ...
				  text: "Data yang telah disimpan tidak bisa dikembalikan ke data sebelumnya.",
				  type: 'warning',
		...
		$(document).on("click", "#btnReload", function(){
			...
			$(".content").empty();
			$(".content").addClass('loadingHalaman');
			$(".content").load("editCatKesehatanIbuHamil.php", {noReg: nmr}, function(){
				$(".content").removeClass('loadingHalaman');
			});
		});
