		...
		<nav id="ml-menu" class="menu">
			...
			<div class="menu__wrap">
				...
				<ul data-menu="submenu-1" id="submenu-1" class="menu__level" tabindex="-1" role="menu" aria-label="Data Ibu">
					<li class="menu__item" role="menuitem"><a class="menu__link" href="#">Identitas Ibu Hamil</a></li>
					<li class="menu__item" role="menuitem"><a class="menu__link" href="#">Catatan Kesehatan</a></li>
					<li class="menu__item" role="menuitem"><a class="menu__link" href="#">Persiapan Persalinan</a></li>
				...
				setTimeout(function() {
					...
					switch(itemName){
						...
						case "Catatan Kesehatan":
							$(".content").addClass('loadingHalaman');
							$(".content").load("editCatKesehatanIbuHamil.php", function(){
								$(".content").removeClass('loadingHalaman');
							});
							break;
						case "Persiapan Persalinan":
							$(".content").addClass('loadingHalaman');
							$(".content").load("editMenyambutPersalinan.php", function(){
								$(".content").removeClass('loadingHalaman');
							});
							break;
